...
# Fetch all repositories for the selected organization
if org_name:
    try:
...
# Multi-selection dropdown for Repository Selection
selected_repos = st.sidebar.multiselect("Select Repositories:", repo_names)
...
# Fetch data for the selected repositories
if selected_repos:
    ...
    st.write("Please select at least one repository.")
