...
texts = [f"{dev}: {data['commits']} commits, {data['additions']} additions, {data['deletions']} deletions. Details: {'; '.join(data['commit_details'])}" for dev, data in developer_data.items()]
...
for developer, data in developer_data.items():
    st.write(f"{developer}: {data['commits']} commits, {data['additions']} additions, {data['deletions']} deletions in repository {repo_name}. Details: {'; '.join(data['commit_details'])}")
