...
const consumeTopics = "cds.invoice"; // Reader topics
const consumeTopics_inv = "invoice.status"; // Reader topics
...
const readers_inv = new Reader({//new Reader({
  brokers: brokers,
  topic: consumeTopics_inv,
  sasl: saslConfig,
  tls: tlsConfig,
});
...
export default function () {
  ...
  let messages_inv = readers_inv.consume({ limit: 100 });
