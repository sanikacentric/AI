...
//const consumeTopic = "cds.invoice|invoice.status";
const consumeTopic = "cds.invoice";//reader
const consumeTopicInv = "invoice.status";//reader
...
const readerInv = new Reader({
  brokers: brokers,
  topic: consumeTopicInv,
  sasl: saslConfig,
  tls: tlsConfig,
});
...
export default function () {
  ...
  let messagesInv = readerInv.consume({ limit: 100 });
